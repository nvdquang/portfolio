export const initialPortfolioData = {
  ...
  "skillCategories": [
    ...
    {
      "id": "architecture",
      "name": "Kiến trúc & DevOps"
    },
    {
      "id": "academic",
      "name": "Giảng dạy & Nghiên cứu"
    }
  ],
  "skills": [
    {
    ...
    {
      "name": "Machine Learning (Scikit-Learn, PyTorch)",
      "level": 82,
      "category": "ai",
      "icon": "Brain"
    },
    ...
    {
      "name": "Cloud Architecture (AWS, Linux Server)",
      "level": 80,
      "category": "architecture",
      "icon": "Cloud"
    },
    {
      "name": "RESTful API & GraphQL Design",
      "level": 92,
      "category": "architecture",
      "icon": "Network"
    },
    {
      "name": "Giảng dạy & Xây dựng Giáo trình",
      "level": 95,
      "category": "academic",
      "icon": "GraduationCap"
    },
    {
      "name": "Nghiên cứu Khoa học Công nghệ",
      "level": 88,
      "category": "academic",
      "icon": "BookOpen"
    },
    {
      "name": "Hướng dẫn Đồ án Tốt nghiệp",
      "level": 92,
      "category": "academic",
      "icon": "Users"
    }
